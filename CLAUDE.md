...
- **Domain:** techai.pk · **Kickoff:** 2026-05-12 · **Target launch:** 2026-06-02 (3 weeks)
...
- [`docs/plan.md`](docs/plan.md) — **order of operations.** Day-by-day execution plan, domain reconciliation (`abdulwahab.dev` → `techai.pk`), decision gates.
...
- Owner email until `hello@techai.pk` is provisioned: `abdul@duckercreative.com`.
